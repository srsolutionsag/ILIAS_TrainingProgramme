...
* @version $Id: class.ilPCParagraphGUI.php 56874 2015-01-07 20:28:42Z akill $
*
	...
	*/
	...
	static function getStyleSelector($a_selected, $a_chars, $a_use_callback = false)
	{
		...
		foreach ($chars as $char => $char_lang)
		{
			...
			$html = '<div class="ilCOPgEditStyleSelectionItem"><'.$tag.' class="ilc_'.$t.'_'.$char.'" style="margin-top:2px; margin-bottom:2px; text-indent:0px; position:static;">'.$char_lang."</".$tag."></div>";
